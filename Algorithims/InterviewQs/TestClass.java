class TestClass {
    ...
    public static void main(String args[] ) throws Exception {
		...
		//Inputs
		int kMax[] = t.kMaxElements(in, k); //get K biggest elements in myArray.
		int kMin[] = t.kMinElements(in, k); //get K smallest elements in myArray.

		System.out.println("Kth Largest elements:");
		for (i = 0; i < kMax.length; i++) {
			System.out.println(kMax[i]);
		}
		System.out.println("Kth Smallest elements:");
		for (i = 0; i < kMin.length; i++) {
			System.out.println(kMin[i]);
		}
